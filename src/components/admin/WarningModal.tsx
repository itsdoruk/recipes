    ...
    >
      <div className="p-8 shadow-2xl max-w-md w-full border" style={{ background: 'var(--background)', borderColor: 'var(--outline)', color: 'var(--foreground)', borderRadius: 0 }}>
        ...
        <div className="flex gap-2 justify-end">
          <button onClick={onClose} className="px-3 py-1 border border-gray-200 dark:border-gray-800 font-medium cursor-pointer hover:opacity-80 transition-opacity" style={{ color: 'var(--foreground)', background: 'var(--background)', borderRadius: 0 }}>Cancel</button>
          <button onClick={onAddWarning} className="px-3 py-1 border border-gray-200 dark:border-gray-800 font-medium cursor-pointer hover:opacity-80 transition-opacity" style={{ color: 'var(--warning)', background: 'var(--background)', borderRadius: 0 }}>Add Warning</button>
        </div>
      </div>
    </Modal>
  );
